...
import { handleEditCars, setBrand, setCategory, setCity, setLocatsia, setModel } from "../../store/autozumadminSlice";
  ...
  return (
    <div className="create-body-cars">
      ...
      <label htmlFor="">Category</label>
        <Select required onChange={(e) => dispatch(setCategory(e.target.value))}>
      ...
      <label htmlFor="">Location</label>
        <Select required onChange={(e) => dispatch(setLocatsia(e.target.value))}>
